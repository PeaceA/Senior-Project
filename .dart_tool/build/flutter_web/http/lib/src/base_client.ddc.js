define(['dart_sdk', 'packages/http_parser/http_parser', 'packages/pedantic/pedantic'], function(dart_sdk, packages__http_parser__http_parser, packages__pedantic__pedantic) {
  ...
  var Uint8ListToResponse = () => (Uint8ListToResponse = dart.constFn(dart.fnType(response$.Response, [typed_data.Uint8List])))();
  var _HashSetOfHttpRequest = () => (_HashSetOfHttpRequest = dart.constFn(collection._HashSet$(html.HttpRequest)))();
  ...
  var ResponseToString = () => (ResponseToString = dart.constFn(dart.fnType(core.String, [response$.Response])))();
  var ResponseToUint8List = () => (ResponseToUint8List = dart.constFn(dart.fnType(typed_data.Uint8List, [response$.Response])))();
  ...
  var _openHttpRequest = dart.privateName(browser_client, "_openHttpRequest");
