define(['dart_sdk', 'packages/quiver/core', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__quiver__core, packages__flutter__src__gestures__arena) {
  ...
  var MapOfString$dynamicToGoogleSignInUserData = () => (MapOfString$dynamicToGoogleSignInUserData = dart.constFn(dart.fnType(types.GoogleSignInUserData, [MapOfString$dynamic()])))();
  var MapOfString$dynamicToGoogleSignInTokenData = () => (MapOfString$dynamicToGoogleSignInTokenData = dart.constFn(dart.fnType(types.GoogleSignInTokenData, [MapOfString$dynamic()])))();
  ...
  method_channel_google_sign_in.MethodChannelGoogleSignIn = class MethodChannelGoogleSignIn extends google_sign_in_platform_interface.GoogleSignInPlatform {
    ...
    requestScopes(scopes) {
      return this.channel.invokeMethod(core.bool, "requestScopes", new (IdentityMapOfString$ListOfString()).from(["scopes", scopes]));
    }
  };
