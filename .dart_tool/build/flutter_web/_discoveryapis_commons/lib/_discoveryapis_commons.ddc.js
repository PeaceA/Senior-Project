define(['dart_sdk', 'packages/http/src/base_client'], function(dart_sdk, packages__http__src__base_client) {
  ...
  var intToDuration = () => (intToDuration = dart.constFn(dart.fnType(core.Duration, [core.int])))();
  ...
  var FutureOfStreamedResponse = () => (FutureOfStreamedResponse = dart.constFn(async.Future$(streamed_response.StreamedResponse)))();
  var VoidToFutureOfStreamedResponse = () => (VoidToFutureOfStreamedResponse = dart.constFn(dart.fnType(FutureOfStreamedResponse(), [])))();
  ...
  var StreamControllerOfString = () => (StreamControllerOfString = dart.constFn(async.StreamController$(core.String)))();
  ...
  var ResumableChunkToFuture = () => (ResumableChunkToFuture = dart.constFn(dart.fnType(async.Future, [clients.ResumableChunk])))();
  var ListOfintToNull = () => (ListOfintToNull = dart.constFn(dart.fnType(core.Null, [ListOfint()])))();
  var StreamedResponseToNull = () => (StreamedResponseToNull = dart.constFn(dart.fnType(core.Null, [streamed_response.StreamedResponse])))();
  var UriToFutureOfStreamedResponse = () => (UriToFutureOfStreamedResponse = dart.constFn(dart.fnType(FutureOfStreamedResponse(), [core.Uri])))();
  var dynamicToUri = () => (dynamicToUri = dart.constFn(dart.fnType(core.Uri, [dart.dynamic])))();
  var FutureOfUri = () => (FutureOfUri = dart.constFn(async.Future$(core.Uri)))();
  var StreamedResponseToFutureOfUri = () => (StreamedResponseToFutureOfUri = dart.constFn(dart.fnType(FutureOfUri(), [streamed_response.StreamedResponse])))();
  var StreamedResponseToFuture = () => (StreamedResponseToFuture = dart.constFn(dart.fnType(async.Future, [streamed_response.StreamedResponse])))();
  var dynamicToFutureOfStreamedResponse = () => (dynamicToFutureOfStreamedResponse = dart.constFn(dart.fnType(FutureOfStreamedResponse(), [dart.dynamic])))();
  var FutureOrOfStreamedResponse = () => (FutureOrOfStreamedResponse = dart.constFn(async.FutureOr$(streamed_response.StreamedResponse)))();
  var StreamedResponseToFutureOrOfStreamedResponse = () => (StreamedResponseToFutureOrOfStreamedResponse = dart.constFn(dart.fnType(FutureOrOfStreamedResponse(), [streamed_response.StreamedResponse])))();
  var intToFutureOfStreamedResponse = () => (intToFutureOfStreamedResponse = dart.constFn(dart.fnType(FutureOfStreamedResponse(), [core.int])))();
  var JSArrayOfResumableChunk = () => (JSArrayOfResumableChunk = dart.constFn(_interceptors.JSArray$(clients.ResumableChunk)))();
  var JSArrayOfListOfint = () => (JSArrayOfListOfint = dart.constFn(_interceptors.JSArray$(ListOfint())))();
  var JSArrayOfApiRequestErrorDetail = () => (JSArrayOfApiRequestErrorDetail = dart.constFn(_interceptors.JSArray$(requests.ApiRequestErrorDetail)))();
  var dynamicToApiRequestErrorDetail = () => (dynamicToApiRequestErrorDetail = dart.constFn(dart.fnType(requests.ApiRequestErrorDetail, [dart.dynamic])))();
