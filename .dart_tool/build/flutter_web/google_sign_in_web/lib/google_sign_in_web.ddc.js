define(['dart_sdk', 'packages/google_sign_in_platform_interface/google_sign_in_platform_interface', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__google_sign_in_platform_interface__google_sign_in_platform_interface, packages__flutter__src__gestures__arena) {
  ...
  var gapi = Object.create(dart.library);
  ...
  var JSArrayOfHtmlElement = () => (JSArrayOfHtmlElement = dart.constFn(_interceptors.JSArray$(html.HtmlElement)))();
  var StringToNull = () => (StringToNull = dart.constFn(dart.fnType(core.Null, [core.String])))();
  var FutureOfGoogleUser = () => (FutureOfGoogleUser = dart.constFn(async.Future$(dart.anonymousJSType("GoogleUser"))))();
  var dynamicToFutureOfGoogleUser = () => (dynamicToFutureOfGoogleUser = dart.constFn(dart.fnType(FutureOfGoogleUser(), [], [dart.dynamic])))();
  var OfflineAccessOptionsToFuture = () => (OfflineAccessOptionsToFuture = dart.constFn(dart.fnType(async.Future, [], [dart.anonymousJSType("OfflineAccessOptions")])))();
  var FutureOfAuthResponse = () => (FutureOfAuthResponse = dart.constFn(async.Future$(dart.anonymousJSType("AuthResponse"))))();
  var VoidToFutureOfAuthResponse = () => (VoidToFutureOfAuthResponse = dart.constFn(dart.fnType(FutureOfAuthResponse(), [])))();
  var dynamicAnddynamicAnddynamicToFuture = () => (dynamicAnddynamicAnddynamicToFuture = dart.constFn(dart.fnType(async.Future, [], [dart.dynamic, dart.dynamic, dart.dynamic])))();
  ...
  var GoogleAuthTodynamic = () => (GoogleAuthTodynamic = dart.constFn(dart.fnType(dart.dynamic, [dart.lazyJSType(() => dart.global.gapi.auth2.GoogleAuth, "gapi.auth2.GoogleAuth")])))();
  var GoogleAuthToNull = () => (GoogleAuthToNull = dart.constFn(dart.fnType(core.Null, [dart.lazyJSType(() => dart.global.gapi.auth2.GoogleAuth, "gapi.auth2.GoogleAuth")])))();
