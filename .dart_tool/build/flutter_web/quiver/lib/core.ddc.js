define(['dart_sdk'], function(dart_sdk) {
  ...
  var intAnddynamicToint = () => (intAnddynamicToint = dart.constFn(dart.fnType(core.int, [core.int, dart.dynamic])))();
  const CT = Object.create(null);
  var _value = dart.privateName(core$, "_value");
  const _is_Optional_default = Symbol('_is_Optional_default');
  var _value$ = dart.privateName(core$, "Optional._value");
  core$.Optional$ = dart.generic(T => {
    ...
    var OptionalOfT = () => (OptionalOfT = dart.constFn(core$.Optional$(T)))();
