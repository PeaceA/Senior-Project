define(['dart_sdk', 'packages/google_sign_in_platform_interface/google_sign_in_platform_interface', 'packages/google_sign_in/src/common', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__google_sign_in_platform_interface__google_sign_in_platform_interface, packages__google_sign_in__src__common, packages__flutter__src__gestures__arena) {
  ...
  var StreamControllerOfGoogleSignInAccount = () => (StreamControllerOfGoogleSignInAccount = dart.constFn(async.StreamController$(google_sign_in.GoogleSignInAccount)))();
  ...
  var FutureOrOfGoogleSignInAccount = () => (FutureOrOfGoogleSignInAccount = dart.constFn(async.FutureOr$(google_sign_in.GoogleSignInAccount)))();
  var voidToFutureOrOfGoogleSignInAccount = () => (voidToFutureOrOfGoogleSignInAccount = dart.constFn(dart.fnType(FutureOrOfGoogleSignInAccount(), [dart.void])))();
