define(['dart_sdk', 'packages/flutter/material', 'packages/flutter/src/widgets/actions', 'packages/google_sign_in/src/common', 'packages/flutter/src/rendering/animated_size'], function(dart_sdk, packages__flutter__material, packages__flutter__src__widgets__actions, packages__google_sign_in__src__common, packages__flutter__src__rendering__animated_size) {
  ...
  var _buildClippedImage = dart.privateName(widgets, "_buildClippedImage");
  ...
  var C27;
  var C26;
  var identity$ = dart.privateName(widgets, "GoogleUserCircleAvatar.identity");
  var foregroundColor$ = dart.privateName(widgets, "GoogleUserCircleAvatar.foregroundColor");
  var backgroundColor$ = dart.privateName(widgets, "GoogleUserCircleAvatar.backgroundColor");
  var placeholderPhotoUrl$ = dart.privateName(widgets, "GoogleUserCircleAvatar.placeholderPhotoUrl");
